...
After listening to “Building a Career in Data Science, Chapter 4: Building a Portfolio”, I think that the discussion was extremely insightful with exhibiting the usefulness of having a personal website. I know from my experience with applying to "analyst/data scientist" type roles over the past year that it is imperative to have easily showcased work to separate yourself from the compeition, and so having an organized website that can clearly and efficiently articulate what you are capable of doing could serve as a logical way to craft your portfolio and enable its accessibility to the public.
